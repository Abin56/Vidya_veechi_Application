...
import 'package:vidya_veechi/view/home/exam_Notification/list_of_exam/list_of_exam.dart';
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            GestureDetector(
              onTap: () {
                Get.off(() => const ViewSchoolExamScreen());
              },
              child: Container(
            ...
            GestureDetector(
              onTap: () {
                Get.off(() => const ExmNotifications());
              },
              child: Container(
                decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(10),
